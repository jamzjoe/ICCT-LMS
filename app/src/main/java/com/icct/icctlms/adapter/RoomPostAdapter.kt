...
class RoomPostAdapter(private val postList: ArrayList<RoomPostData>) : RecyclerView.Adapter<RoomPostAdapter.MyViewHolder>(){

    private lateinit var mListener: RoomPostAdapter.onItemClickListener
    ...
    fun setOnItemClickListener(listener: RoomPostAdapter.onItemClickListener){
        mListener = listener
    ...
    override fun onBindViewHolder(holder: RoomPostAdapter.MyViewHolder, position: Int) {
