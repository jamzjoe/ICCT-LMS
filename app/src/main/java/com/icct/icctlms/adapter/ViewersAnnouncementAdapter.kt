...
class ViewersAnnouncementAdapter(private val announcementList: ArrayList<AnnouncementData>) : RecyclerView.Adapter<ViewersAnnouncementAdapter.MyViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewersAnnouncementAdapter.MyViewHolder, position: Int) {
