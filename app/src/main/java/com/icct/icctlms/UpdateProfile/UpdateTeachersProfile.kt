...
import com.icct.icctlms.databinding.ActivityUpdateTeachersProfileBinding
import kotlinx.android.synthetic.main.activity_update_student_profile.*
import kotlinx.android.synthetic.main.nav_header.*
import java.io.File

class UpdateTeachersProfile : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityUpdateTeachersProfileBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityUpdateTeachersProfileBinding.inflate(layoutInflater)
...
//button hide to Un hide
            ...
            database.child(uid).updateChildren(user).addOnSuccessListener {
                ...
                MaterialAlertDialogBuilder(this)
                    ...
                    .setPositiveButton("Yes, Logout"){dialog, which ->
                        ...
                        val intent = Intent(this@UpdateTeachersProfile, TeacherLogin::class.java)
                        startActivity(intent)
                    }
    ...
    private fun uploadImage() {
        ...
        addOnSuccessListener {
            ...
            Toast.makeText(this@UpdateTeachersProfile, "Successfully uploaded!!", Toast.LENGTH_SHORT).show()
            showProfile()
            progressDialogHide()
        }.addOnFailureListener{
            progressDialogHide()
            Toast.makeText(this@UpdateTeachersProfile, "Failed to Upload.", Toast.LENGTH_SHORT).show()
        }.addOnCanceledListener {
            Toast.makeText(this@UpdateTeachersProfile, "No information updated.", Toast.LENGTH_SHORT).show()
        }
